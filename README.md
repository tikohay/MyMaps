# An application similar to gps navigation, in which I added a framework from google maps, added CoreLocation, CLGeocoder, UserNotifications, AVFoundation. And realised the possibility to record you audio
